                ...
                $(".aiz-count-down").each(function () {
                    ...
                    $this.countdown(date).on("update.countdown", function (event) {
                        var $this = $(this).html(
                            event.strftime(
                                "" +
                                    '<div class="countdown-item"><span class="countdown-digit"><h1 class="h1 fw-600" style="font-size: 3rem!important;margin-bottom: -25px!important;">%-D</h1> <br/><p>Days</p></span></div><span class="countdown-separator"><h1 class="h1 fw-600" style="font-size: 3rem!important;margin-top: -40px!important;color: #fff;">:</h1></span>' +
                                    '<div class="countdown-item"><span class="countdown-digit"><h1 class="h1 fw-600" style="font-size: 3rem!important;margin-bottom: -25px!important;">%H</h1> <br/><p>Hours</p></span></div><span class="countdown-separator"><h1 class="h1 fw-600" style="font-size: 3rem!important;margin-top: -40px!important;color: #fff;">:</h1></span>' +
                                    '<div class="countdown-item"><span class="countdown-digit"><h1 class="h1 fw-600" style="font-size: 3rem!important;margin-bottom: -25px!important;">%M</h1> <br/><p>Minutes</p></span></div><span class="countdown-separator"><h1 class="h1 fw-600" style="font-size: 3rem!important;margin-top: -40px!important;color: #fff;">:</h1></span>' +
                                    '<div class="countdown-item"><span class="countdown-digit"><h1 class="h1 fw-600" style="font-size: 3rem!important;margin-bottom: -25px!important;">%S</h1> <br/><p>Seconds</p></span></div>'
                            )
                        );
                    });
