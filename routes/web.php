...
Route::get('/campaigns', 'HomeController@all_flash_deals')->name('flash-deals');
...
Route::get('/bkash/querypayment', 'BkashController@queryPayment')->name('bkash.query');
...
Route::get('/our-showroom','ContactController@showroom')->name('showroom');  
