...
class ProductController extends Controller
{
    ...
    public function all_products(Request $request)
    {
        ...
        $seller_id = null;
        $sort_search = null;
        $products = Product::orderBy('updated_at', 'desc')->where('auction_product',0);
        if ($request->has('user_id') && $request->user_id != null) {
            $products = $products->where('user_id', $request->user_id);
            $seller_id = $request->user_id;
        }
    ...
    public function store(Request $request)
    {
        ...
        $product->bangla_name = $request->bangla_name;
        ...
        $product->hover_img = $request->hover_img;
        $product->campaign_img = $request->campaign_img;
        ...
        $product->tos = $request->tos;
        $product->campaign_tos = $request->campaign_tos;
...
//            dd($flash_deal_product);
        ...
        $product_translation->unit          = $request->unit;
        $product_translation->description   = $request->description;
        $product_translation->tos   = $request->tos;
        $product_translation->campaign_tos   = $request->campaign_tos;
        $product_translation->save();
