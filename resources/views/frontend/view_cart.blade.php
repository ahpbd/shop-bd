            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <ul class="list-inline social colored text-center mb-3">
                            @if (get_setting('facebook_login') == 1)
                                <li class="list-inline-item" style="margin-right: 0!important;">
                                    <a href="{{ route('social.login', ['provider' => 'facebook']) }}" class="facebook" style="display: inline-block;width: 205px!important;/* height: 36px; */border-radius: 0.2em;line-height: 39px;text-align: center;color: #fff;font-size: 24px;">
                            ...
                            @if(get_setting('google_login') == 1)
                                <li class="list-inline-item" style="margin-right: 0!important;">
                                    <a href="{{ route('social.login', ['provider' => 'google']) }}" class="google" style="display: inline-block;width: 205px!important;/* height: 36px; */border-radius: 0.2em;line-height: 39px;text-align: center;color: #fff;font-size: 24px;">
                    ...
                    <div class="text-center mb-3">
                        <p class="text-muted mb-0">{{ translate('New member?')}} <a href="{{ route('user.registration') }}">{{ translate('Register Now')}}</a> here.</p>
