                    ...
                    @csrf
                                        ...
                                        <label class="aiz-megabox d-block bg-white mb-0">
                                            ...
                                            <span class="d-flex p-3 aiz-megabox-elem">
                                                ...
                                                <span class="flex-grow-1 pl-3 text-left">
                                                    <div>
                                                        <span class="opacity-60">{{ translate('Address (In Details)') }}:</span>
                                                    ...
                                                    <div>
                                                        <span class="opacity-60">{{ translate('City/District') }}:</span>
                        ...
                        @else
                            <div class="shadow-sm bg-white p-4 rounded mb-4">
                                ...
                                <div class="form-group">
                                    <label class="control-label">{{ translate('Address (In Details)')}}</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <label class="control-label">{{ translate('City/District')}}</label>
            ...
            <form class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            <div class="col-md-2">
                                <label>{{ translate('Address (In Details)')}}</label>
                            </div>
                            <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label>{{ translate('City/District')}}</label>
                            </div>
                            <div class="col-md-10">
