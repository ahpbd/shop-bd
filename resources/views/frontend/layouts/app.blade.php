...
<head>
    ...
    img.img-fit.mx-auto.image-hover {
      position: absolute;
      top: 0;
      right: 0;
      left: 0;
    ...
    img:hover.img-fit.mx-auto.image-hover {
...
<style>
    ...
    <style>
        ...
        a.fs-14.px-3.py-2.d-inline-block.fw-600.hov-opacity-100.text-reset {
    color: #862633!important;
}
a.fs-14.px-3.py-2.d-inline-block.fw-600.hov-opacity-100.text-reset:hover {
    color: #000!important;
}
.buy_btn {
    font-family: "Barlow",Arial,Helvetica,sans-serif;
    ...
    color: #fff !important;
    background-image: linear-gradient(to top, #fff 5%, #000 50%);
}
