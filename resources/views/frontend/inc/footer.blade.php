        ...
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <h4 class="fs-13 text-uppercase fw-600 border-bottom border-gray-900 pb-2">CONNECT WITH US</h4>
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                           <a class="opacity-50 hov-opacity-100 text-reset" href="">Featured products</a>
                        </li>
                        <li class="mb-2">
                           <a class="opacity-50 hov-opacity-100 text-reset" href="">Latest products</a>
                        </li>
                        <li class="mb-2">
                           <a class="opacity-50 hov-opacity-100 text-reset" class="opacity-50 hov-opacity-100 text-reset" href="">Best Selling Product</a>
                        </li>
                        <li class="mb-2">
                        <a class="opacity-50 hov-opacity-100 text-reset" href="">Top Rated Product</a>
                        </li>
                        <li class="mb-2">
                        <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('categories.all') }}">All Category</a>
                        </li>
                    </ul>
            ...
            <div class="col-md-4 col-lg-2">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            <a class="opacity-50 hov-opacity-100 text-reset" href="{{ route('showroom') }}">
                                {{ translate('Our Showroom') }}
                            </a>
                        </li>
                        <li class="mb-2">
                    ...
                    <ul class="list-inline mb-0">
                        @if ( get_setting('payment_method_images') !=  null )
                            @foreach (explode(',', get_setting('payment_method_images')) as $key => $value)
                                <li class="list-inline-item">
                                    <img src="https://shop.alharamainperfumes.com/media/wysiwyg/safe_secure_iso2.png" alt="ISO" height="40" class="mw-100 h-auto" style="max-height: 30px">
                                    <img src="{{ uploaded_asset($value) }}" height="40" class="mw-100 h-auto" style="max-height: 30px">
                                </li>
                            @endforeach
                        @endif
                    </ul>
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col-auto">
            <a href="{{ route('cart') }}" class="text-reset d-block text-center pb-2 pt-3">
                <span class="align-items-center border border-white border-width-4 d-flex justify-content-center position-relative rounded-circle size-50px" style="background: #862633; margin-top: -33px;box-shadow: 0px -5px 10px rgb(0 0 0 / 15%);border-color: #fff !important;">
                    <i class="las la-shopping-bag la-2x text-white"></i>
                    <!--<i class="la-2x text-white"><img src="https://alharamainperfumes.xyz/public/assets/img/Asset-4.svg" height="32" width="32"></i>-->
                </span>
