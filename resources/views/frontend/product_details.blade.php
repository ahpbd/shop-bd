                        ...
                        <div class="sticky-top z-3 row gutters-10">
                            ...
                            <div class="col order-1 order-md-2">
                                <div class="aiz-carousel product-gallery" data-nav-for='.product-gallery-thumb' data-fade='true' data-auto-height='true'>
                                  @if(((strtotime(date('Y-m-d H:i:s')) <= $detailedProduct->discount_end_date) == true) && (($detailedProduct->discount_start_date <= (strtotime(date('Y-m-d H:i:s')))) == true))
                                  
                                            <div class="carousel-box img-zoom rounded">
                                                <img
                                                    class="img-fluid lazyload"
                                                    src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                                    data-src="{{ uploaded_asset($detailedProduct->campaign_img) }}"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="text-left">
                            <h1 class="mb-2 fs-20 fw-600">
                              {{--@dd(\App\Language::all()->first()->bd)--}}
                                  {{--@if(((strtotime(date('Y-m-d H:i:s')) <= $detailedProduct->discount_end_date) == true) && (($detailedProduct->discount_start_date <= (strtotime(date('Y-m-d H:i:s')))) == true))
            
                                  <span style="font-family: kalpurush;">{{ $detailedProduct->bangla_name }}</span>
                            ...
                            <div class="row align-items-center">
                             ...
                             <p style="color:#495057;font-size: 16px; font-weight: normal!important; font-family: Goudy Old Style;">
                          <i class="las la-eye"></i>
                          {{ rand(10,500) }} People are Viewing this item Right Now.
                        </p>
                            
                            <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                                  <?php echo $detailedProduct->getTranslation('tos'); ?>
                            </div>
                            ...
                            @if(home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-sm-2">
                                        <div class="opacity-100 my-2" style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{ translate('Price')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                ...
                                <div class="row no-gutters my-2">
                                    <div class="col-sm-2" style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">
                            ...
                            @if (addon_is_activated('club_point') && $detailedProduct->earn_point > 0)
                                <div class="row no-gutters mt-4">
                                    <div class="col-sm-2">
                                        <div class="opacity-100 my-2" style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{  translate('Club Point') }}:</div>
                                    </div>
                                    <div class="col-sm-10">
                            ...
                            <form id="option-choice-form">
                                ...
                                @if ($detailedProduct->choice_options != null)
                                    ...
                                    <div class="row no-gutters mt-3">
                                        <div class="col-sm-2">
                                            <div class="opacity-100 my-2" style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{ \App\Attribute::find($choice->attribute_id)->getTranslation('name') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                ...
                                @if (count(json_decode($detailedProduct->colors)) > 0)
                                    <div class="row no-gutters mt-3">
                                        <div class="col-sm-2">
                                            <div class="opacity-100 my-2" style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{ translate('Color')}}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="aiz-radio-inline">
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-sm-2">
                                        <div class="opacity-100 my-2" style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{ translate('Quantity')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="row no-gutters align-items-center aiz-plus-minus mr-3 border all-side-border-radius" style="width: 130px; border-radius: 10px 10px 10px 10px !important;border: 1px solid #862633!important;">
                                                <button class="btn col-auto btn-icon btn-sm btn-circle btn-light22" type="button" data-type="minus" data-field="quantity" disabled="" style="border-radius: 0.5em 0em 0em 0.5em;">
                                                ...
                                                <button class="btn  col-auto btn-icon btn-sm btn-circle btn-light22" type="button" data-type="plus" data-field="quantity"  style="border-radius: 0em 0.5em 0.5em 0em;">
                                ...
                                <div class="row no-gutters pb-3 d-none mt-3" id="chosen_price_div">
                                    <div class="col-sm-2">
                                        <div class="opacity-100 my-2" style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{ translate('Total Price')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-3">
                                        <div class="opacity-100 my-2"><b style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{ translate('Product Code')}}: </b></div>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="opacity-100 my-2"> <b style="color:#495057;font-size: 16px; font-weight: normal!important; font-family: Goudy Old Style;">
                                       {{ $detailedProduct->stocks[0]->sku; }}</b>
                                       </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <div class="row no-gutters">
                                    <!--<div class="col-sm-2">
                                        <div class="opacity-100 my-2"><b style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">{{ translate('Charge')}}: </b></div>
                                    </div>-->
                                    <!--<div class="rounded" style="border: 2px solid #862633; padding: 10px;">
                                    <div class="col-sm-12 rounded">
                                        <div class="product-description-label"><b style="color:#495057;font-size: 16px; font-family: Goudy Old Style;">
                                           <i class="la la-motorcycle" aria-hidden="true"></i> Inside Dhaka City Delivery Charge 60 Taka<br>
                                           <i class="la la-truck" aria-hidden="true"></i> Outside Dhaka City Delivery Charge 130 Taka</b>
                                        </div>
                                    </div>
                                </div>-->
                              </div>
                            ...
                            <div class="row no-gutters mt-4">
                                ...
                                <div class="col-sm-10">
                                    <div class="aiz-share" style="margin: 0!important;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 bg-white rounded shadow-sm mb-3">
                        ...
                        <div class="p-3">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        <div class="col-3">
                                            <a href="{{ route('product', $top_product->slug) }}" class="d-block text-reset">
                                                <img
                                                    class="img-fit lazyload" style="height: 100%; width: 100%;"
                                                    src="{{ static_asset('assets/img/placeholder.jpg') }}"
                ...
                <div class="col-xl-12 order-0 order-xl-1">
                    <div class="bg-white mb-3 shadow-sm rounded">
                        <div class="nav border-bottom aiz-nav-tabs">
                          @if($detailedProduct->accords != null)
                            <a href="#tab_default_5" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset active show" style="text-transform: uppercase;">{{ translate('Accords')}}</a>
                          @endif
                            <a href="#tab_default_1" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset active show" style="text-transform: uppercase;">{{ translate('Description')}}</a>
                            @if($detailedProduct->video_link != null)
                                <a href="#tab_default_2" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset" style="text-transform: uppercase;">{{ translate('Video')}}</a>
                            @endif
                            @if($detailedProduct->pdf != null)
                                <a href="#tab_default_3" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset" style="text-transform: uppercase;">{{ translate('Downloads')}}</a>
                            @endif
                                <a href="#tab_default_4" data-toggle="tab" class="p-3 fs-16 fw-600 text-reset" style="text-transform: uppercase;">{{ translate('Reviews')}}</a>
                        </div>
                          ...
                          <div class="tab-pane fade active show" id="tab_default_5">
                              <div class="p-4">
                                  ...
                                  <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                                      ...
                                      <?php echo $detailedProduct->getTranslation('accords'); ?>
                                  </div>
                            ...
                            <div class="tab-pane fade active show" id="tab_default_1">
                                <div class="p-4">
                                  @if((strtotime(date('Y-m-d H:i:s')) <= $detailedProduct->discount_end_date) == true)
                                  @if(($detailedProduct->discount_start_date <= (strtotime(date('Y-m-d H:i:s')))) == true)
                            		<div class="mw-100 overflow-hidden text-left aiz-editor-data" style="font-family: Kalpurush; font-size: 22px;">
                                  	<?php echo $detailedProduct->getTranslation('campaign_tos'); ?>
                            		</div>
                                  @else
                                  <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                    ...
                    <div class="bg-white rounded shadow-sm">
                        ...
                        <div class="p-3">
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="5" data-lg-items="5"  data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows='true' data-infinite='true'>
                                    ...
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        <div class="">
                                            <a href="{{ route('product', $related_product->slug) }}" class="d-block">
                                                <img
                                                    class="img-fit lazyload mx-auto" style="height: 100%; width: 100%;"
                                                    src="{{ static_asset('assets/img/placeholder.jpg') }}"
