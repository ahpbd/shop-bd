                            ...
                            @foreach ($slider_images as $key => $value)
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <img
                                            class="d-block mw-100 img-fit rounded shadow-sm overflow-hidden lazyload"
        ...
        <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                    <div class="mb-3 align-items-baseline" style="text-align: center;">
                        <h3 class="h5 fw-700 mb-0" style="text-transform: uppercase;">
                            <span class="border-bottom border-primary border-width-2 pb-1 d-inline-block">{{ translate('Shop by Collection') }}</span>
                        </h3>
        ...
        <div class="row">
            <div class="col-lg-8 text-center text-lg-left">
                <video role="presentation" crossorigin="anonymous"
                        playsinline="" preload="auto" muted="" loop="" autoplay="" tabindex="-1" width="100%" height="100%"
                        src="https://alharamainperfumes.com.bd/new/1.mp4"
                        style="width: 100%; height: 100%; object-fit: cover; object-position: center center;border-radius: 5px;">
                        </video>
            </div>
            <div class="col-lg-4">
                <div style="text-align: center;align-self: center;">
                    <h1 style="color: #000; font-family: -webkit-pictograph;"> {{ translate('Exclusive') }}</h1>
                    <p style="color: #000; font-size: xxx-large; margin-bottom: 0rem;text-align: center;font-family: 'Ephesis', cursive;"> {{ translate('Signature') }}</p>
                    <p style="color: #000;font-size: xx-large; margin-bottom: 0rem;text-align: center; font-family: -webkit-pictograph;"> {{ translate('PERFUMES ITEM') }}</p>
                            
                    <div style="text-align: center; padding-top: 60px;" class="pb-2">
                         <button class="buy_btn" onclick="location.href='#'">
                              {{translate('Shop Now')}}
                         </button>
                    </div>
                </div>
